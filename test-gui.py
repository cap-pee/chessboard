...
# # board.setPiece(0, 5, Pawn('white'))

# checkmate test
board.setPiece(0, 0, King('black'))
board.setPiece(0, 1, Queen('white'))
board.setPiece(1, 0, King('white'))


# stalemate test
board.setPiece(0, 7, King('black'))
board.setPiece(1, 5, Queen('white'))
board.setPiece(4, 4, King('white'))
